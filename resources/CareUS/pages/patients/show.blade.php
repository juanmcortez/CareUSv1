    ...
    <x-slot name="subheader">
        ...
        <div
            ...
            <ul
                ...
                <li>
                    <a href="{{ route('patient.detail', ['patient' => $patient->patID]) }}"
                ...
                <li class="mr-4">
                    <form method="POST" action="{{ route('patient.delete', ['patient' => $patient->patID]) }}">
                        @csrf
                        @method('DELETE')
                ...
                <li class="mr-4">{!! __('<strong>Created on:</strong> :date', ['date' =>
                    $patient->created_at]) !!}</li>
                <li>
                    {!! __('<strong>Last updated on:</strong> :date', ['date' => $patient->updated_at]) !!}
                </li>
